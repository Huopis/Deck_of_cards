...
class Deck {
    public:
        ...
        //! @brief Method to fill deck with regular 52 cards. Also possible to fill deck with remaining cards from cards_buffer_. Uses add() method.
        void fill();

        //! @brief Method to draw card from deck to another deck, most commonly to "hand".
        ...
        //! @brief Method to reveal all cards in the deck. Cards are printed to console.
        void reveal();

        //! @brief Method to reveal card from top of the deck. Card is printed to console.
        void reveal_top();

        //! @brief Method to get amount of cards in the deck.
        //! @retval Amount of card in the deck as unsigned integer. If any problems occur returns 0.
        unsigned size();
    private:
